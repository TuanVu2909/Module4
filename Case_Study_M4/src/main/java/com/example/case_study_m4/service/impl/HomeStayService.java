...
import com.example.case_study_m4.repository.IHomeStayRepository;
import com.example.case_study_m4.service.IHomeStayService;
    ...
    public Home_Stay create(Home_Stay homeStay, MultipartFile file) {
        ...
        try {
            if (file != null && !file.isEmpty()) {
                ...
                homeStay.setImage("C:\\Users\\Admin\\Desktop\\Case_Study_M4\\image");
            }
        } catch (IOException e) {
            e.printStackTrace();
        }
